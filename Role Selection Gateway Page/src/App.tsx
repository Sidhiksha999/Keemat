                ...
                <div style={{
                  ...
                  {LANGUAGES.map(lang => (
                    <button
                      ...
                      onMouseEnter={e => { if (lang !== selectedLang) (e.target as HTMLElement).style.backgroundColor = '#FAF9F5' }}
                      onMouseLeave={e => { if (lang !== selectedLang) (e.target as HTMLElement).style.backgroundColor = 'transparent' }}
                    >
                      {lang}
                    </button>
                  ))}
      ...
      <footer style={{ borderTop: '1px solid #E2E2DC', backgroundColor: '#FAF9F5' }}>
        ...
        <div className="max-w-6xl mx-auto px-6" style={{ height: '52px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', color: '#4A4A46', display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <a
              href="#signin"
              style={{ color: '#1A1A18', fontWeight: 600, textDecoration: 'underline', textUnderlineOffset: '2px', textDecorationColor: '#E2E2DC' }}
              onMouseEnter={e => (e.currentTarget.style.textDecorationColor = '#1A1A18')}
              onMouseLeave={e => (e.currentTarget.style.textDecorationColor = '#E2E2DC')}
            >
...
function RoleCard({
  ...
  tag, title, titleSub, subtitle, desc, features, buttonLabel,
}: {
  ...
  desc: string; features: Feature[]; buttonLabel: string;
}) {
  ...
  return (
    ...
    >
      ...
      <p style={{
        fontFamily: "'Inter', sans-serif", fontSize: '0.8rem',
        color: '#8A8A84', marginBottom: '16px', fontWeight: 400,
      }}>
        {subtitle}
      </p>
      ...
      <p style={{
        ...
        color: '#4A4A46', lineHeight: 1.65, marginBottom: '28px', fontWeight: 400,
      }}>
        {desc}
      </p>
